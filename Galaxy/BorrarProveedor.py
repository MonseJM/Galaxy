...
class BorrarProvedor():
    ...
    def DataProB():
        ...
        ventana.title('Borrar el Proveedor ') #Colocamos titulo a la ventana.
        ...
        main_title = Label(text="                            Borrar Proveedor                          ",font=("Bauhaus 93",35),bg="#A3F6C5",fg="black")
        main_title.pack()
        #-------------------------------------------
