...
class ModificarProvedor():
    ...
    def DataProM():
        ...
        ventana.title('Modificar el Proveedor') #Colocamos titulo a la ventana.
        ...
        main_title = Label(text="                            Modificar Proveedor                          ",font=("Bauhaus 93",35),bg="#A3F6C5",fg="black")
        main_title.pack()
        #-------------------------------------------
        codigomod = StringVar()
        ...
        etiqueta1=Label(ventana, text='Telefono:', fg='black', font=("Bauhaus 93",30), bg='white') #Creamos un objeto de la clase etiqueta. --> fg=foreground.
