...
class AgregarArticulo():
    ...
    def Data():
        ...
        main_title = Label(text="                            Agregar Articulo                          ",font=("Bauhaus 93",35),bg="#F4A2CE",fg="black")
        main_title.pack()
        #-------------------------------------------
        ...
        etiqueta1=Label(ventana, text='Precio:', fg='black', font=("Bauhaus 93",35), bg='white') #Creamos un objeto de la clase etiqueta. --> fg=foreground.
