...
class ConsultarProvedor():
    ...
    def DataProC():
        ...
        ventana.title('Consultar Proveedor') #Colocamos titulo a la ventana.
        ...
        main_title = Label(text="                           Consultar Proveedor                         ",font=("Bauhaus 93",35),bg="#A3F6C5",fg="black")
        main_title.pack()
        #-------------------------------------------
        codigo = StringVar()
